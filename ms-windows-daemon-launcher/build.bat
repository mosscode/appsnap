...
mkdir Release\src
cd Release
%MINGW%\bin\g++ -O3 -Wall -c -fmessage-length=0 -osrc\ms-windows-daemon-launcher.o ..\src\ms-windows-daemon-launcher.cpp
%MINGW%\bin\g++ -mwindows  -oms-windows-daemon-launcher.exe src\ms-windows-daemon-launcher.o
copy /Y ms-windows-daemon-launcher.exe ..\..\keeper\src\main\resources\com\moss\appsnap\keeper\windows\ms-windows-daemon-launcher.exe