...
del "C:\Users\stu\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\*keeper*.lnk"
rmdir /s /q "C:\Users\stu\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\stusapps"
rmdir /s /q "C:\Users\stu\AppData\Roaming\appsnap"